...
void enumerateObjectPropertiesUsingBlock(NSObject *object, PropertiesEnumerateBlock block) {
...
BOOL storageExistInObjectForPropertyWithKey(Class objectClass, NSString *propertyKey) {
